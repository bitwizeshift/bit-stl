...
TEST_CASE("string_view::string_view( const char* )","[ctor]")
{
  ...
  {
    bit::stl::string_view view = empty_str;
  ...
  SECTION("Is non-empty with non-empty string")
  {
    ...
    bit::stl::string_view view = non_empty_str;
...
{
  bit::stl::string_view empty = "";
  bit::stl::string_view view  = "Hello world";
...
TEST_CASE("string_view::swap( string_view& )","[modifier]")
{
  ...
  bit::stl::string_view view1 = str1;
  bit::stl::string_view view2 = str2;
...
TEST_CASE("string_view::compare( string_view )","[comparison]")
{
  ...
  {
    bit::stl::string_view view = "Hello";
  ...
  {
    bit::stl::string_view view = "1234567";
...
TEST_CASE("string_view::operator==(...)","[comparison]")
{
  ...
  SECTION("Is equal")
  {
    ...
    {
      bit::stl::string_view view2 = "Hello World";
  ...
  SECTION("Is not equal")
  {
    ...
    {
      bit::stl::string_view view2 = "Goodbye World";

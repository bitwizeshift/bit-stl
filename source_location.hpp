...
#ifndef BIT_SOURCE_LOCATION_HPP
#define BIT_SOURCE_LOCATION_HPP
...
namespace bit {
  ...
  constexpr bool operator==(const source_location& lhs,
  ...
  //!        invoked
# define BIT_MAKE_SOURCE_LOCATION() ::bit::source_location( __FILE__, __func__, __LINE__ )

  //==========================================================================
  // Inline Definitions
  //==========================================================================

  inline constexpr bool operator==(const source_location& lhs, const source_location& rhs)
    noexcept
  {
  ...
  inline constexpr source_location::source_location( const char* file_name,
                                                     const char* function_name,
                                                     std::size_t line )
    : m_file(file_name),
  ...
  inline constexpr const char* source_location::function_name()
    const noexcept
  {
    return m_function;
  }

  inline constexpr const char* source_location::file_name()
    const noexcept
  {
    return m_file;
  }

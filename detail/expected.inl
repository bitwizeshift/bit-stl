...
namespace bit {
  namespace stl {
    ...
    template<typename T>
    inline constexpr expected<T>::expected()
    ...
    template<typename T>
    inline expected<T>::expected( in_place_type_t<std::exception_ptr> )
    ...
    template<typename T>
    inline expected<T>::expected( in_place_type_t<std::exception_ptr>, std::exception_ptr ptr )
      : m_storage( in_place<std::exception_ptr>, ptr ? std::move(ptr) : std::make_exception_ptr(bad_expected_access()) ),
        m_is_exception(true)
    {
    ...
    inline expected<T>::expected( in_place_type_t<Exception> tag, Args&&...args )
      noexcept( std::is_nothrow_constructible<Exception,Args...>::value )
      : expected( in_place<std::exception_ptr>, std::make_exception_ptr( Exception( std::forward<Args>(args)... ) ) )
    {
    ...
    inline expected<T>::expected( in_place_type_t<Exception> tag, std::initializer_list<U> ilist, Args&&...args )
      noexcept( std::is_nothrow_constructible<Exception,std::initializer_list<U>,Args...>::value )
      : expected( in_place<std::exception_ptr>, std::make_exception_ptr( Exception( ilist, std::forward<Args>(args)... ) ) )
    {
    ...
    inline constexpr expected<T>::expected( in_place_t tag, Args&&...args )
    ...
    inline constexpr expected<T>::expected( in_place_t tag, std::initializer_list<U> ilist, Args&&...args )
    ...
    template<typename T>
    inline constexpr expected<T>::expected( const T& value )
    ...
    template<typename T>
    inline constexpr expected<T>::expected( T&& value )
    ...
    template<typename T>
    inline expected<T>::expected( const expected<T>& other )
      : m_storage(),
    ...
    template<typename T>
    inline expected<T>::expected( expected<T>&& other )
      : m_storage(),
        m_is_exception(other.m_is_exception)
    {
      if(other.m_is_exception)
    ...
    template<typename T>
    inline expected<T>& expected<T>::operator=( const expected<T>& other )
    {
    ...
    template<typename T>
    inline expected<T>& expected<T>::operator=( expected<T>&& other )
    {
      if( m_is_exception == other.m_is_exception )
      {
        if( other.m_is_exception )
    ...
    template<typename T>
    inline constexpr expected<T>::operator bool()
      const noexcept
    {
    ...
    template<typename T>
    inline constexpr bool expected<T>::valueless_by_exception()
      const noexcept
    {
    ...
    template<typename T>
    inline constexpr bool expected<T>::has_value()
      const noexcept
    {
      return !m_is_exception;
    }
    ...
    inline bool expected<T>::has_exception()
      const noexcept
    {
    ...
    template<typename T>
    inline constexpr typename expected<T>::value_type*
      expected<T>::operator->()
      noexcept
    {
    ...
    template<typename T>
    inline constexpr const typename expected<T>::value_type*
      expected<T>::operator->()
      const noexcept
    {
      return std::addressof(m_storage.value);
    ...
    template<typename U>
    inline constexpr typename expected<T>::value_type
      expected<T>::value_or( U&& default_value )
      const &
    {
    ...
    template<typename T>
    inline void expected<T>::swap( expected<T>& rhs )
    {
      using std::swap;
    ...
    template<typename T>
    template<typename...Args>
    inline void expected<T>::emplace( Args&&...args )
    ...
    template<typename T>
    template<typename U, typename...Args>
    inline void expected<T>::emplace( std::initializer_list<U> ilist, Args&&...args )
    ...
    template<typename T>
    inline void expected<T>::throw_if_exception()
      const
    {
      if( m_is_exception )
      {
    ...
    template<typename T>
    inline void expected<T>::destruct()
    {
      if( m_is_exception )
      {
    ...
    template<typename T>
    template<typename...Args>
    inline void expected<T>::reconstruct_value( expected<T>& expected, Args&&...args )
    {
    ...
    template<typename T>
    template<typename...Args>
    inline void expected<T>::reconstruct_exception( expected<T>& expected, Args&&...args )
    {
      try {
        expected.destruct();
    ...
    template<typename T>
    inline constexpr bool operator == ( const expected<T>& lhs, const expected<T>& rhs )
      noexcept
    {
    ...
    template<typename T>
    inline constexpr bool operator == ( const T& lhs, const expected<T>& rhs )
      noexcept
    {
    ...
    template<typename T>
    inline constexpr bool operator == ( const expected<T>& lhs, const T& rhs )
      noexcept
    {
      return rhs == lhs;
    }
    ...
    template<typename T>
    inline constexpr expected<std::decay_t<T>> make_expected( T&& value )
    ...
    inline constexpr expected<T> make_expected( Args&&...args )
    ...
    template<typename T>
    inline constexpr std::size_t hash_value( const expected<T>& val )
      noexcept
    {
      if( val )
      {

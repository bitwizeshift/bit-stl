...
namespace bit {
  namespace stl {
    ...
    inline constexpr basic_string_tokenizer<CharT,Traits,Owning>::
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline constexpr typename basic_string_tokenizer<CharT,Traits,Owning>::string_view_type
      basic_string_tokenizer<CharT,Traits,Owning>::delimiters()
      const noexcept
    {
      return m_delimiter;
    }
    ...
    template<typename CharT, typename Traits,bool Owning>
    inline constexpr typename basic_string_tokenizer<CharT,Traits,Owning>::string_view_type
      basic_string_tokenizer<CharT,Traits,Owning>::buffer()
      const noexcept
    {
      return m_buffer;
    }
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline constexpr bool basic_string_tokenizer<CharT,Traits,Owning>::keeps_delimiter()
      const noexcept
    {
    ...
    inline constexpr bool
      basic_string_tokenizer<CharT,Traits,Owning>::has_more()
      const noexcept
    {
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline typename basic_string_tokenizer<CharT,Traits,Owning>::string_view_type
      basic_string_tokenizer<CharT,Traits,Owning>::next()
      noexcept
    {
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline typename basic_string_tokenizer<CharT,Traits,Owning>::string_view_type
      basic_string_tokenizer<CharT,Traits,Owning>::next( const string_view_type& delim )
      noexcept
    {
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline void
      basic_string_tokenizer<CharT,Traits,Owning>::reset()
      noexcept
    {
      m_current = 0;
    }
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline void basic_string_tokenizer<CharT,Traits,Owning>::
      skip_delimiter()
      noexcept
    {
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline typename basic_string_tokenizer<CharT,Traits,Owning>::string_view_type
      basic_string_tokenizer<CharT,Traits,Owning>::
    ...
    template<typename CharT, typename Traits, bool Owning>
    inline bool basic_string_tokenizer<CharT,Traits,Owning>::

 ...
 */
#ifndef BIT_STL_INTERNAL_CONFIG_PLATFORM_GENERIC_POSIX_HPP
#define BIT_STL_INTERNAL_CONFIG_PLATFORM_GENERIC_POSIX_HPP
...
#endif /* BIT_STL_INTERNAL_CONFIG_PLATFORM_GENERIC_POSIX_HPP */
